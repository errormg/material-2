...
jQuery(document).ready(function (a) {
    ...
    a('.support_select input[type="radio"], .update_select input[type="radio"]').click(function(){
    	a('input.submit-next').show();
        if(a(this).attr("value")=="1"){
            a(".block").hide();
            a("#bugfix_select, #content_select").show();
        }
        if(a(this).attr("value")=="2"){
            a(".block").hide();
            a("#tpw_select, #feature_select").show();
        }
    });
